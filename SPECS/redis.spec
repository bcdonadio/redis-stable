...
Patch0006:            0006-redis-3.2.8-geohash-library-fPIC-performance-tuning.patch
%if 0%{?with_perftools}
...
sed -i -e 's|$(CFLAGS)|%{optflags}|g' deps/geohash-int/Makefile
sed -i -e 's|$(LDFLAGS)|%{?__global_ldflags}|g' deps/geohash-int/Makefile
...
- Replace CFLAGS and LDFLAGS for geohash-int
